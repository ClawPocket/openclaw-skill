            ...
            <DocsContent>
                ...
                <div className="steps space-y-8">
                    ...
                    <div className="step">
                        ...
                        <p>
                            Get your API key from your <Link href="/dashboard" className="text-orange-400 hover:underline">Agent Dashboard</Link> and export it as an environment variable.
                        </p>
                        <div className="relative group mt-3">
                            <pre className="bg-zinc-950 p-4 rounded-lg overflow-x-auto text-sm border border-white/10">
