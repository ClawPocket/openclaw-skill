                        ...
                        <div className="flex-1 min-w-0 space-y-2">
                            <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-3">
                                ...
                                <div className="flex flex-wrap gap-2 mt-1 md:mt-0">
                                    ...
                                    {agent.type === "clawpocket" ? (
                                        ...
                                        <Badge className="text-xs border px-2.5 py-0.5 bg-orange-500/10 text-orange-400 border-orange-500/20">
                                            ZeptoClaw
                                        </Badge>
                                    ) : (
                            ...
                            {agent.skills && agent.skills.length > 0 && (
                                <div className="flex flex-wrap gap-2 pt-2">
                                    {agent.skills.map((skill, i) => (
                                        <Badge key={i} variant="outline" className="text-[10px] bg-white/[0.05] border-white/10 text-zinc-300">
                                            {skill}
                                        </Badge>
                                    ))}
                                </div>
                            ...
                            {agent.externalLinks && Object.keys(agent.externalLinks).length > 0 && (
                                <div className="flex gap-3 mt-1">
                                    ...
                                    {/* GitHub Icon (using basic path or lucide if available? Lucide has Github? No key, but maybe GitBranch/Code?) */}
